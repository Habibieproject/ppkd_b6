...
class LoginScreenDay20 extends StatefulWidget {
  const LoginScreenDay20({super.key});

  @override
  State<LoginScreenDay20> createState() => _LoginScreenDay20State();
}

class _LoginScreenDay20State extends State<LoginScreenDay20> {
  ...
  void login() async {
    ...
    if (pengguna != null) {
      context.pushAndRemoveAll(HomeScreenDay20());
    } else {
